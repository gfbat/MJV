...
public class Application {
    public static void main(String[] args) {
        ...
        Cadastro comprador = FabricaCadastro.criarCadastro("Gui", "gui@mail.com", 123456789L);
        ...
        File dir = new File("C:\\Users\\Gui\\IdeaProjects\\MJV\\java-project\\src\\myapp\\cupom");
        try {
